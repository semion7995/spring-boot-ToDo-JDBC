...
public class ToDoRepository implements CommonRepository<ToDo> {
    ...
    public static final String SQL_INSERT = "INSERT into todo (id, description, created, modified, completed) values (:id, :description, :created, :modified, :completed)";
    ...
    public static final String SQL_UPDATE = "update todo set description = :description, modified = :modified, completed = :completed WHERE id = :id";
